...
\usepackage[paperwidth=8.5in, paperheight=11in, margin=0.8in]{geometry}
...
\begin{document}
  ...
  \begin{titlepage}
    ...
    \begin{center}
      \huge{Learn Text Vis}\\[0.5cm]
      \large {An introduction to text analysis and visualization}\\[0.4cm]
    \end{center}
    \vspace*{\fill}
  % \clearpage
  \end{titlepage}
